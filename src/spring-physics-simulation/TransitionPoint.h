...
public:
	...
	TransitionPoint(unsigned int Index) : coordinate(spring_start_length * Index / spring_parts), index(Index), weight(spring_mass / spring_parts) {
	...
	void update_position(simulation_time t);
};
